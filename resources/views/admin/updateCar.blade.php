            ...
            <div class="md:w-2/3 w-5/6 md:px-24 px-4 pb-8 mx-auto mt-2 space-y-12 bg-white border-2 border-gray-600 rounded-md">
                <div class=" border-b border-gray-900/10 pb-12">
                    <h2 class="mt-2 text-center font-bold text-lg leading-7 text-gray-900">Updating the car: <span
                            class="text-pr-400">{{ $car->name }} {{ $car->brand }} {{ $car->model }} {{ $car->engine }}</span></h2>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            <label for="car_type" class="block text-sm font-medium leading-6 text-gray-900">Car Type</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="daily_rent_price" class="block text-sm font-medium leading-6 text-gray-900">Daily Rent Price</label>
                            <div class="mt-2">
                                <input type="text" name="daily_rent_price" id="daily_rent_price"
